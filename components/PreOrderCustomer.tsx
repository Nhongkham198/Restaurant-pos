...
export const PreOrderCustomer: React.FC = () => {
    ...
    return (
        <div className="h-screen w-screen flex flex-col bg-gray-50 overflow-hidden font-sans text-gray-900">
            ...
            {/* Scrollable Container containing Header, Categories, and Menu */}
            ...
            {/* Categories */}
            <div className="sticky top-0 bg-white border-b border-gray-100 flex overflow-x-auto py-4 px-2 gap-2 scrollbar-hide shrink-0 z-30 shadow-sm">
                <button 
            ...
            {/* Menu Grid */}
            <main className="p-4 tabletP:p-6 flex-1">
