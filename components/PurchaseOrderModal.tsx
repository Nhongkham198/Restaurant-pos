...
export const PurchaseOrderModal: React.FC<PurchaseOrderModalProps> = ({ isOpen, onClose, stockItems, currentUser, isMobileMode, onUpdateStock }) => {
    ...
    return (
        <div 
            ...
            className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center sm:p-4 print:p-0 print:block print:bg-white print:static z-[80]"
        >
            <style>
                {`
                    @media print {
            ...
            <div 
                ...
                className="bg-white w-full max-w-4xl h-full sm:h-[80vh] flex flex-col sm:rounded-lg shadow-xl overflow-hidden" 
