...
export const MenuItemCard: React.FC<MenuItemCardProps> = ({ item, onSelectItem, isEditMode, onEdit, onDelete, onDragStart, onDragEnter, onDragEnd, isRecommended }) => {
    ...
    return (
        ...
        >
            ...
            {isRecommended && (
                <div className="absolute top-2 right-2 flex items-center justify-center w-8 h-8" title="เมนูแนะนำ">
